...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'created_by' => 'Регистратор',
            'updated_at' => 'Время редактирование',
            'updated_by' => 'Обновлено',
            'current_pass' => 'Текущий пароль',
            'new_pass' => 'Новый пароль',
            'retype_pass' => 'Подтвердить пароль',
        ];
    }
    ...
    public static function getUsers(){
      return  ArrayHelper::map(self::find()->where(['is_block' => 0])->asArray()->all(), 'user_id', 'fio');
    }
